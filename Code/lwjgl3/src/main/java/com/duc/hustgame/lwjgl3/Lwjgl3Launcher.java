package com.duc.hustgame.lwjgl3;
import com.duc.hustgame.HustGame;
...
public class Lwjgl3Launcher {
    ...
    private static Lwjgl3Application createApplication() {
        return new Lwjgl3Application(new HustGame(), getDefaultConfiguration());
    }

    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        Lwjgl3ApplicationConfiguration configuration = new Lwjgl3ApplicationConfiguration();
        configuration.setTitle("BKHN_Adventure");
        ...
        // Request a 16-bit depth buffer, 8-bit stencil buffer
        configuration.setBackBufferConfig(8, 8, 8, 8, 16, 8, 0);   //// They can also be loaded from the root of assets/ .
