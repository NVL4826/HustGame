...
public class MilkCoffee extends BaseCoffee {
    @Override
    public String getId() { return "coffee_sua"; }
    @Override
    public String getName() { return "Cà Phê Sữa"; }
    @Override
    public String getDescription() { return "Hồi 20 HP, 25 Thể lực, tăng tốc và hồi máu theo thời gian."; }
