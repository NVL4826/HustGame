...
/**
 * Abstract class for all logical items in the game.
 * Inherits from GameObject to reuse identity attributes (ID, Name, spritePath)
 * and introduces a description field.
 */
