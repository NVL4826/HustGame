...
/**
 * Factory class for creating Gear instances and applying their immediate equip/upgrade side-effects.
 * Uses a registry-based provider pattern for mapping equip effects.
 */
