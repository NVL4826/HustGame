...
/**
 * A weapon that fires a projectile in the player's current looking direction
...
public class BunDauWeapon extends BaseWeapon {
    ...
    public BunDauWeapon(final Player owner, final float baseDamage, final float cooldown, final float area) {
        super(owner, "bun_dau", "Bun Dau", "Bắn một viên đậu theo hướng nhìn hiện tại khi nhấn phím Space.", baseDamage, cooldown, area);
    }
